...
<?php 
	...
	$sql = "SELECT render_tb.render_id, rules_tb.rule_id, trainee_tb.trainee_id, trainee_tb.first_name, trainee_tb.last_name, trainee_tb.class, 
	trainee_tb.class_group, trainee_tb.team,
